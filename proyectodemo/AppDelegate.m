...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [QBSettings setApplicationID:8629];
    [QBSettings setAuthorizationKey:@"ffxnGPb5u7nWQtj"];
    [QBSettings setAuthorizationSecret:@"MYvV2RkzSmEY79v"];
    
    NSMutableDictionary *videoChatConfiguration = [[QBSettings videoChatConfiguration] mutableCopy];
    [videoChatConfiguration setObject:@30 forKey:kQBVideoChatCallTimeout];
